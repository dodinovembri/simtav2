        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Status konfirmasi penguji kompre</li>
                </ol>
            </nav>
            <h4 class="content-title content-title-xs">Status konfirmasi penguji kompre</h4>
        </div>
    </div>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($student_thesis_examiners as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <a href="{{ url('manage_student_thesis/edit_comprehensive_examiner', $value->id) }}"><i class="fa fa-edit" style="margin-left: 8px"></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
