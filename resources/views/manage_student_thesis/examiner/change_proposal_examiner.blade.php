        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Ubah Dosen Penguji Seminar Proposal Mahasiswa</li>
                </ol>
            </nav>
            <h4 class="content-title content-title-xs">Ubah Dosen Penguji Seminar Proposal Mahasiswa</h4>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card card-body pd-sm-40 pd-md-30 pd-xl-y-35 pd-xl-x-40">
                    <div class="tab-content">
                        <form action="{{ url('manage_student_thesis/store_change_proposal_examiner', $student_thesis_examiner_id) }}" method="POST" enctype="multipart/form-data" id="formValidation">
