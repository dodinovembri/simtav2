							...
							<tbody>
								...
								foreach ($lecturers as $key => $value) {
									...
									<tr>
										...
										<td>
											<a href="{{ url('lecturer/show', $value->id) }}"><i class="fa fa-eye"></i></a>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-footer">
													...
													<a href="{{ url('lecturer/destroy', $value->id) }}"><button type="button" class="btn btn-dark rounded-5">Delete</button></a>
												</div>
											</div>
										</div>
									</div>
