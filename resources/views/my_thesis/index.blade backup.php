					...
					<div class="row row-sm">
						...
						<div class="col-sm-9">
							<div class="timeline-body">
								...
								<div class="card card-timeline card-timeline-note">
									<h5>Input Perpanjang TA.</h5>
									<p class="mg-b-0">In this lesson, you create a layout in XML that includes a text field and a button. In the next lesson, your app responds when the...<a href="{{ url('my_thesis/create_extension_proposal_seminar') }}">Input Sekarang!</a></p>
								</div>
							</div><!-- timeline-body -->
						</div>
					</div><!-- row -->
