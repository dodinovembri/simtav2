        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Input SK Komprehensif</li>
                </ol>
            </nav>
            <h4 class="content-title content-title-xs">Input SK Komprehensif</h4>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card card-body pd-sm-40 pd-md-30 pd-xl-y-35 pd-xl-x-40">
                    <div class="tab-content">
                        <form action="{{ url('my_thesis/store_comprehensive_certificate') }}" method="POST" enctype="multipart/form-data" id="formValidation">
                            ...
                            <div id="paneProfile" class="tab-pane active show">
                                ...
                                <div class="form-group">
                                    <label class="form-label">File SK Komprehensif</label>
                                    <input type="file" class="form-control" name="comprehensive_certificate" id="consultation_file" required>
