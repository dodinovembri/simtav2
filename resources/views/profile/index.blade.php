                    ...
                    <div class="row row-xs">
                        <div class="col-md-12">
                            <div class="tab-content">
                                ...
                                <form action="{{ url('profile/update', Auth::user()->id) }}" method="POST" id="fieldForm" enctype="multipart/form-data">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <div id="paneProfile" class="tab-pane active show">
                                        <h6 class="tx-uppercase tx-semibold tx-color-01 mg-b-0">Edit Profil</h6>
                                        <hr>
