    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="{{ url('manage_my_student_thesis/agree_to_extend_proposal', $extend_proposal_seminar->id) }}"><button type="button" class="btn btn-primary">Setujui</button></a>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="reject" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('manage_my_student_thesis/reject_to_extend_proposal', $extend_proposal_seminar->id) }}" method="POST">
                <div class="modal-body">
