                ...
                <div class="card card-body pd-sm-40 pd-md-30 pd-xl-y-35 pd-xl-x-40">
                    <div class="tab-content">
                        ...
                        <div id="paneProfile" class="tab-pane active show">
                            <h6 class="tx-uppercase tx-semibold tx-color-01 mg-b-0">Konfirmasi kesediaan menguji Komprehensif</h6>
                            <hr>
                            ...
                            <div class="form-group">
                                ...
                                <p>{{ $college_student->comprehensive_schedule }}</p>
                            </div><!-- form-group -->

                            <hr class="op-0">

                            @include('manage_my_student_thesis.view_link.components.comprehensive_action')
                        </div><!-- tab-pane -->
                    </div>
                </div><!-- tab-content -->
            </div><!-- card -->
