    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="mg-b-0">Anda yakin bersedia untuk menguji seminar proposal? </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                <a href="{{ url('manage_my_student_thesis/proposal_seminar_confirm_agree', $college_student->id) }}"><button type="button" class="btn btn-primary">Bersedia</button></a>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="not_ready" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('manage_my_student_thesis/proposal_seminar_confirm_reject', $college_student->id) }}" method="POST" id="fieldForm">
                <div class="modal-body">
