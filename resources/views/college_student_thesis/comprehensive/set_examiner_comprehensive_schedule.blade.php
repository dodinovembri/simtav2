        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Set Jadwal Komprehensif</li>
                </ol>
            </nav>
            <h4 class="content-title content-title-xs">Set Jadwal Komprehensif</h4>
        </div>
    </div>
                ...
                <div class="card card-body pd-sm-40 pd-md-30 pd-xl-y-35 pd-xl-x-40">
                    <div class="tab-content">
                        ...
                        <div id="paneProfile" class="tab-pane active show">
                            <h6 class="tx-uppercase tx-semibold tx-color-01 mg-b-0">Penguji Komprehensif</h6><br>
                            ...
                            <hr>
                            <form action="{{ url('college_student_thesis/store_comprehensive_schedule', $college_student->id) }}" method="POST" id="fieldForm">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                <div class="form-group">
                                    <label class="form-label">Jadwal Seminar Proposal</label>
                                    <input type="datetime-local" class="form-control col-sm-4" name="comprehensive_schedule" required>
                                </div><!-- form-group -->

                                <div class="form-group">
                                    <button class="btn btn-brand-01">Simpan</button>
                                    <a href="{{ url('college_student_thesis') }}"><button type="button" class="btn btn-white mg-l-2">Batal</button></a>
                                </div><!-- form-group -->
                            </form>
                            <hr class="op-0">
                        </div><!-- tab-pane -->
