            ...
            <div class="col-md-12">
                <div class="card card-body pd-sm-40 pd-md-30 pd-xl-y-35 pd-xl-x-40">
                    <div class="tab-content">
                        <form action="{{ url('college_student_thesis/store_kkt_file') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div id="paneProfile" class="tab-pane active show">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="kkt_file[]" required>
                                ...
                                <div class="form-group">
                                    <table width="100%">
                                        <tr>
                                            <td>Jumlah SKS tempuh<input type="text" name="total_sks_now" class="form-control" placeholder="Jumlah SKS tempuh" required></td>
                                            <td>Jumlah SKS Transkrip<input type="text" name="total_sks_transkrip" class="form-control" placeholder="Jumlah SKS Transkrip" required></td>
                                        </tr>
                                    </table>
