						...
						<div class="col-sm-9">
							<div class="timeline-body">
								...
								<div class="card card-timeline card-timeline-note">
									...
									<p class="mg-b-0">In this lesson, you create a layout in XML that includes a text field and a button. In the next lesson, your app responds when the...<a href="{{ url('college_student_thesis/create_kkt_file') }}">Upload Sekarang!</a></p>
								</div>
							</div><!-- timeline-body -->
						</div>
					</div><!-- row -->
