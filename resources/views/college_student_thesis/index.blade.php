		...
		<div>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Skripsi Mahasiswa</li>
				</ol>
			</nav>
			<h4 class="content-title content-title-xs">List Skripsi Mahasiswa</h4>
		</div>
	</div>
						...
						<table id="example1" class="table">
							<thead>
								<tr>
									...
									<th class="wd-25p">Kode Skripsi Mahasiswa</th>
									<th class="wd-20p">Nama Skripsi Mahasiswa</th>
